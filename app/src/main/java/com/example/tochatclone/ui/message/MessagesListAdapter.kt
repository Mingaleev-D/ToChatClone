...
import com.example.tochatclone.databinding.ItemIncomingMessageBinding
import com.example.tochatclone.databinding.ItemOutgoingMessageBinding
...
class MessagesListAdapter(
   ...
   override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseListViewHolder<*> {
      return when (viewType) {
         INCOMING_MESSAGE -> {
            val itemBinding = ItemIncomingMessageBinding.inflate(
         ...
         OUTGOING_MESSAGE -> {
            val itemBinding = ItemOutgoingMessageBinding.inflate(
               LayoutInflater.from(parent.context),
               parent,
               false
            )
   ...
   inner class BindIncomingMessage(private val binding: ItemIncomingMessageBinding) :
      BaseListViewHolder<Message>(binding.root) {
   ...
   inner class BindOutgoingMessage(private val binding: ItemOutgoingMessageBinding) :
      BaseListViewHolder<Message>(binding.root) {
